...
-(id)init {
    if((self = [super initWithSpriteFrameName: @"xFistUp-Idle-01.png"])){
        //attributes
        self.carryingItem = YES;
        self.item = [RandomItem node];
        ...
        self.knockedOutAction = [CCSequence actions:[CCAnimate actionWithAnimation:knockedOutAnimation], [CCBlink actionWithDuration:2.0 blinks:10.0], [CCCallFuncND actionWithTarget:self selector:@selector(removeFromParentAndCleanup:) data:(void*)NO], nil];
